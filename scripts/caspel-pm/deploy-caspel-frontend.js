...
async function main() {
  ...
  // Write patched 29614.d85bc7d194e7b0cfc6f6.js and .gz
  const p29614 = path.join(root, 'dev/prod/dist/29614.d85bc7d194e7b0cfc6f6.js');
  fs.writeFileSync(p29614, js29614);
  fs.writeFileSync(p29614 + '.gz', zlib.gzipSync(Buffer.from(js29614)));
  execSync(`docker cp "${p29614}" dev-front-1:/app/dist/29614.d85bc7d194e7b0cfc6f6.js`);
  execSync(`docker cp "${p29614}.gz" dev-front-1:/app/dist/29614.d85bc7d194e7b0cfc6f6.js.gz`);
  console.log('Deployed patched 29614 chunk and .gz to container');
  ...
  fs.writeFileSync(p81373, js81373);
  fs.writeFileSync(p81373 + '.gz', zlib.gzipSync(Buffer.from(js81373)));
  execSync(`docker cp "${p81373}" dev-front-1:/app/dist/81373.a2dc27c3c90c4ba900b1.js`);
  execSync(`docker cp "${p81373}.gz" dev-front-1:/app/dist/81373.a2dc27c3c90c4ba900b1.js.gz`);
  console.log('Deployed patched 81373 chunk and .gz to container');
